...
void action_main_dropdown_changed(lv_event_t * e)
{
    ...
    case 0:
        ...
        lv_dropdown_set_selected(objects.dropdown_1, 0);
        break;
    case 1:
        loadScreen(SCREEN_ID_STRING);
        lv_dropdown_set_selected(objects.dropdown_2, 1);
        break;
    case 2:
        loadScreen(SCREEN_ID_FAULTS);
        lv_dropdown_set_selected(objects.dropdown_3, 2);
        break;
    case 3:
        loadScreen(SCREEN_ID_CONTROL);
        lv_dropdown_set_selected(objects.dropdown_4, 3);
        break;
    case 4:
        loadScreen(SCREEN_ID_SETTINGS);
        lv_dropdown_set_selected(objects.dropdown_5, 4);
        break;
    default:
        break;
    }
