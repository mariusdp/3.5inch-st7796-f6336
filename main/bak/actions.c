...
void action_button1_pressed(lv_event_t * e) {loadScreen(SCREEN_ID_SCR2);} // Navigate to screen scr2
void action_button2_pressed(lv_event_t * e) {loadScreen(SCREEN_ID_LIDIA_HOME);} // Navigate to screen lidia_home
...
void action_button6_pressed(lv_event_t * e) {loadScreen(SCREEN_ID_FT);} // Navigate to screen ft
