...
// #include "esp_lcd_touch_ft6336/include/esp_lcd_touch_ft6336.h"
...
#define EXAMPLE_PIN_LCD_DC GPIO_NUM_13 //GPIO_NUM_9
#define EXAMPLE_PIN_LCD_RST GPIO_NUM_15
...
void esp_3inch5_touch_port_init(esp_lcd_touch_handle_t *touch_handle, i2c_master_bus_handle_t bus_handle, uint16_t xmax, uint16_t ymax, uint16_t rotation)
{
    ...
    /* Touch IO handle */
    ESP_ERROR_CHECK(esp_lcd_new_panel_io_i2c_v2(bus_handle, &touch_io_config, &touch_io_handle));
